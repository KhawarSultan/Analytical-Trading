                ...
                <div className="flex gap-2 mt-10">
                    <div className="flex p-6 gap-3 items-center card flex-1 justify-between">
                        <div className="flex items-center gap-3">
                            <span className="material-symbols-outlined bg-orange-600 rounded-lg p-2 text-white">account_balance</span>
                        ...
                        <span
                            className="material-symbols-outlined bg-blue-600 rounded-full px-3  p-1 text-white cursor-pointer"
                            onClick={() => { setModal(true) }}
                        >ADD</span>
                    </div>
                    <div className="flex p-6 gap-3 items-center card flex-1">
                        <span className="material-symbols-outlined bg-orange-600 rounded-lg p-2 text-white">currency_bitcoin</span>
                        <div className="flex flex-col">
