    ...
    return (
        <>
            <div className="cryptos-page flex w-full">
                <div className="flex flex-col gap-5  w-full mx-10">
                    {/* <AnimatePresence>
                    ...
                    <div className="table-section flex flex-col gap-5">
                        <p className=" text-4xl font-extrabold  text-center py-10 text-orange-500 flex justify-center items-center gap-3">Crypto Currencies</p>
